...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ScourgenWebBundle', ($this->targetDirs[2].'/Resources/ScourgenWebBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ScourgenWebBundle', ($this->targetDirs[3].'/src/Scourgen/WebBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Scourgen/WebBundle/Entity'))), 'Scourgen\\WebBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ScourgenWebBundle' => 'Scourgen\\WebBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_10bf4cb3e2a1116f7b5232093474e0e68705c14e9caa350b290c3e62383dfef7');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '5bb32f40fb4a4c35df51fd264770b1dbf222c026');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ScourgenWebBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Scourgen/WebBundle/Resources/views'), 'ScourgenWeb');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5bb32f40fb4a4c35df51fd264770b1dbf222c026');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ScourgenWebBundle' => 'Scourgen\\WebBundle\\ScourgenWebBundle',
            ...
            'locale' => 'en',
            'secret' => '5bb32f40fb4a4c35df51fd264770b1dbf222c026',
            ...
            'kernel.secret' => '5bb32f40fb4a4c35df51fd264770b1dbf222c026',
